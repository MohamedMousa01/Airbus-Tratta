...
public class Tratta {
    ...
    @JoinColumn(name = "id_airbus", nullable = false)
    private Airbus airbus;

    public Tratta(){}

    public Tratta(String codice, String descrizione, LocalDate data, LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato, Airbus airbus) {
        this.codice = codice;
    ...
    // Esempio del costruttore necessario nella Entity Tratta
    public Tratta(Long id, String codice, String descrizione, LocalDate data,
                  LocalTime oraDecollo, LocalTime oraAtterraggio, Stato stato) {
        this.id = id;
        this.codice = codice;
        this.descrizione = descrizione;
        this.data = data;
